...
private:
    void draw_line(const Vertex& v1, const Vertex& v2, const Vertex& v3, float barycentic_denom, int64_t x1, int64_t x2, int64_t y, uint32_t* buffer, const SDL_Surface* texture);
    void draw_pixel(const Pixel& p, const Vertex& v1, const Vertex& v2, const Vertex& v3, float barycentic_denom, uint32_t* buffer, const SDL_Surface* texture);
    ...
    math::Matrix<4, 4> get_transform_matrix() const;
